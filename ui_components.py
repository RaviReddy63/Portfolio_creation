...
def create_customer_filters_for_mapping(customer_data):
    ...
    with col_clear2:
        ...
        if st.button("Clear filters", key="clear_mapping_filters", help="Clear customer selection filters", type="secondary"):
            ...
            mapping_filter_keys = ["mapping_cust_state", "mapping_role", "mapping_cust_portcd", "mapping_cs_new_ns", "mapping_min_revenue", "mapping_min_deposit"]
    ...
    return cust_state, role, cust_portcd, cs_new_ns, None, min_rev, min_deposit
